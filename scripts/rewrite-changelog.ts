 ...
 * to a small model (default `openai-codex/gpt-5.6-luna` via `@bbcli/pi-ai`),
...
import { type Api, completeSimple, Effort, type Model, type Tool, type ToolCall } from "@bbcli/pi-ai";
import { discoverAuthStorage } from "@bbcli/pi-ai/auth-broker";
