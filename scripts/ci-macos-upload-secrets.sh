...
# terminal transcript.
#
# Prepare a directory (default ~/bbcli-signing) containing:
...
#   OMP_REPO=owner/repo scripts/ci-macos-upload-secrets.sh ~/bbcli-signing
...
DIR="${DIR:-${OMP_SIGNING_DIR:-$HOME/bbcli-signing}}"
REPO="${BBCLI_REPO:-${OMP_REPO:-${GITHUB_REPOSITORY:-BadryansahBangsawan/bbclii}}}"
