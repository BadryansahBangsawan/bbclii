...
const SUMS = {
	"bbcli-darwin-arm64": "darwin_arm64_sha",
	"bbcli-darwin-x64": "darwin_x64_sha",
	"bbcli-linux-arm64": "linux_arm64_sha",
	"bbcli-linux-x64": "linux_x64_sha",
};
...
describe("renderFormula", () => {
	...
	it("attaches `using: :nounzip` to every per-platform url stanza", () => {
		...
		for (const arch of ["bbcli-darwin-arm64", "bbcli-darwin-x64", "bbcli-linux-arm64", "bbcli-linux-x64"]) {
