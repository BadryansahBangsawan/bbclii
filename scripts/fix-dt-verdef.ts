 ...
 * both of which bbcli's nix fixup chain does — it relocates the dynamic-section
 ...
 * ELF64 little-endian only — the only shape bbcli's Linux outputs take. Binaries
