...
import { toolWireSchema } from "@bbcli/pi-ai";
import { Settings } from "@bbcli/pi-coding-agent/config/settings";
import { BUILTIN_TOOLS, GithubTool, HIDDEN_TOOLS, IrcTool, type Tool, type ToolFactory, type ToolSession } from "@bbcli/pi-coding-agent/tools";
