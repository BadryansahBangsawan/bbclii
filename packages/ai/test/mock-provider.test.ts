...
import { clearCustomApis, getCustomApi } from "@bbcli/pi-ai/api-registry";
import {
	createMockModel,
	isMockModel,
	MOCK_API,
	...
	registerMockApi,
	streamMock,
} from "@bbcli/pi-ai/providers/mock";
import type { AssistantMessage, AssistantMessageEvent, Context, ToolCall } from "@bbcli/pi-ai/types";
