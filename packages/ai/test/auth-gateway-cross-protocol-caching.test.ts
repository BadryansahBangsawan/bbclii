 ...
 *     → openai-responses parser → bbcli Context
 ...
 * with the gateway live (`bbcli auth-gateway serve` or pm2).
 */
...
the bbcli auth-gateway's cross-protocol prompt-caching pipeline. The request
