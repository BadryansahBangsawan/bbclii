...
import { buildRequest } from "@bbcli/pi-ai/providers/google-gemini-cli";
import { convertTools } from "@bbcli/pi-ai/providers/google-shared";
import type { Context, Model, TJsonSchema, Tool } from "@bbcli/pi-ai/types";
import {
	enforceStrictSchema,
