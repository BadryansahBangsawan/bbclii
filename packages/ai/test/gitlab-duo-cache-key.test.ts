...
import type { Context } from "@bbcli/pi-ai";
import {
	clearGitLabDuoDirectAccessCache,
	getGitLabDuoModels,
	streamGitLabDuo,
} from "@bbcli/pi-ai/providers/gitlab-duo";
import * as registerBuiltins from "@bbcli/pi-ai/providers/register-builtins";
import { apiRouteFor } from "@bbcli/pi-catalog/compat/behavior";
import { getBundledModel } from "@bbcli/pi-catalog/models";
import { resolveGitLabDuoModelIdentity } from "@bbcli/pi-catalog/provider-models";
