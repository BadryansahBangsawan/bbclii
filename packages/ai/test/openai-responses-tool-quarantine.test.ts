...
import { buildParams, convertTools } from "@bbcli/pi-ai/providers/openai-responses";
import type { Context, Model, ModelSpec, Tool } from "@bbcli/pi-ai/types";
import { findStrictToolSchemaViolation } from "@bbcli/pi-ai/utils/schema";
