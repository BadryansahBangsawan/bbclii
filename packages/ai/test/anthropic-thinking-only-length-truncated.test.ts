...
import type { AssistantMessage, Message, Model, UserMessage } from "@bbcli/pi-ai/types";
 ...
 *
 * Reproduces the shape captured in `~/.bbcli/logs/http-400-requests/*.json` after Claude
