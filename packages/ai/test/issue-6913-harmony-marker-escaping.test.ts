...
import type { ResponseInput } from "@bbcli/pi-ai/providers/openai-responses-wire";
import { buildResponsesInput } from "@bbcli/pi-ai/providers/openai-shared";
import type { AssistantMessage, Context, ToolResultMessage, UserMessage } from "@bbcli/pi-ai/types";
...
function harmonyPoisonedContext(): { context: Context; user: UserMessage; toolResult: ToolResultMessage } {
	...
	const toolResult: ToolResultMessage = {
		...
		toolName: "grep",
		isError: false,
		content: [{ type: "text", text: `bbcli://toolconv/harmony.md: ${MARKER}\nmore docs` }],
		timestamp: 0,
	};
