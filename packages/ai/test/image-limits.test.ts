...
import { complete } from "@bbcli/pi-ai/stream";
import type { Api, Context, ImageContent, Model, OptionsForApi, UserMessage } from "@bbcli/pi-ai/types";
import { getBundledModel } from "@bbcli/pi-catalog/models";
import { $which, removeSyncWithRetries } from "@bbcli/pi-utils";
import { e2eApiKey } from "./oauth";

const TEMP_DIR = fs.mkdtempSync(path.join(os.tmpdir(), "bbcli-temp-images-"));
