/**
 * Test helper for resolving API keys from ~/.bbcli/agent/testauth.db
 *
...
import { getOAuthApiKey } from "@bbcli/pi-ai/oauth";
import type { OAuthCredentials, OAuthProvider } from "@bbcli/pi-ai/oauth/types";
import { $flag, getAgentDir, isEnoent } from "@bbcli/pi-utils";
...
/**
 * Resolve API key for a provider from ~/.bbcli/agent/testauth.db
 *
