 ...
 * (containerized bbcli, robomp's sidecar auth-gateway).
 ...
 * `SimpleStreamOptions` from older / newer bbcli builds without per-version
 * conditionals.
 */
 ...
 * targets (containerized bbcli → host gateway, robomp slot → bbcli-auth-gateway
