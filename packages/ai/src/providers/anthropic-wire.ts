...
/** Web-search server-tool call whose matching result is replayable by bbcli. */
export type WebSearchServerToolUseBlockParam = ServerToolUseBlockParam & { name: "web_search" };

/** Tool-search server-tool call whose matching result is replayable by bbcli. */
...
/** Anthropic server-tool history variants bbcli can replay atomically. */
...
/** True when a block is complete Anthropic server-tool history bbcli can replay. */
