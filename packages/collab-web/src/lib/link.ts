 ...
 * link/envelope half of `@bbcli/pi-coding-agent/src/collab/protocol.ts`;
...
import type { ParsedCollabLink } from "@bbcli/pi-wire";
import {
	DEFAULT_RELAY_URL,
...
export { COLLAB_PROTO } from "@bbcli/pi-wire";
