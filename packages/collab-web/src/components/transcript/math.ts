import type { MarkedExtension, Tokens } from "@bbcli/pi-utils/marked";
import { type MathSpan, mathBlockAt, mathSpanAt, mathStartIndex } from "@bbcli/pi-utils/math-delimiters";
 ...
 * scan hint come from `@bbcli/pi-utils/math-delimiters`, so this renderer and
