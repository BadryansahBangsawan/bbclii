...
import { getOAuthProviders } from "@bbcli/pi-ai/registry/oauth";
import { getEnvApiKey } from "@bbcli/pi-ai/stream";
import { getBundledModelReferenceIndex } from "@bbcli/pi-catalog/identity/bundled";
import { resolveModelReference } from "@bbcli/pi-catalog/identity/reference";
import type { ProviderCatalogEntry } from "@bbcli/pi-catalog/provider-models/descriptor-types";
import {
	CATALOG_PROVIDERS,
	DEFAULT_MODEL_PER_PROVIDER,
	PROVIDER_DESCRIPTORS,
} from "@bbcli/pi-catalog/provider-models/descriptors";
import {
	MODELS_DEV_PROVIDER_DESCRIPTORS,
	siliconflowCnModelManagerOptions,
	siliconflowModelManagerOptions,
} from "@bbcli/pi-catalog/provider-models/openai-compat";
import type { FetchImpl } from "@bbcli/pi-catalog/types";
