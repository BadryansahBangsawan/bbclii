/**
 * Issue #2113 — `kimik2 does not work on the latest bbcli`
 *
...
import { type OpenAICompletionsOptions, streamOpenAICompletions } from "@bbcli/pi-ai/providers/openai-completions";
import type { AssistantMessage, Context } from "@bbcli/pi-ai/types";
...
import { moonshotModelManagerOptions } from "@bbcli/pi-catalog/provider-models/openai-compat";
import type { Model, ModelSpec } from "@bbcli/pi-catalog/types";
