...
import { convertMessages } from "@bbcli/pi-ai/providers/openai-completions";
import { getOAuthProviders } from "@bbcli/pi-ai/registry/oauth";
import type { AssistantMessage, ThinkingContent, ToolCall } from "@bbcli/pi-ai/types";
import { buildModel } from "@bbcli/pi-catalog/build";
import { xiaomiModelManagerOptions } from "@bbcli/pi-catalog/provider-models/openai-compat";
