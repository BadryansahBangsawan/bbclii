...
import { MODELS_DEV_PROVIDER_DESCRIPTORS, mapModelsDevToModels } from "@bbcli/pi-catalog/provider-models";
 ...
 * `bbcli --model amazon-bedrock/us-gov.…` fails model resolution even though
