/**
 * Manual end-to-end smoke for the relay: replicates the bbcli browser tool's
...
/** Puppeteer keeps the CDP target id on an internal field; same access the bbcli tab supervisor uses (`targetIdForPage`). */
