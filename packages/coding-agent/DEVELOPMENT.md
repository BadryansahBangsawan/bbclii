# Developing `@bbcli/pi-coding-agent`

This package is the `bbcli` CLI. This file is a **developer's map**: where things live
...
| Build the `dist/bbcli` binary | `bun run build` |
