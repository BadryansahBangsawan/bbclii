 ...
 */
import { createAgentSession, discoverSkills, SessionManager, type Skill } from "@bbcli/pi-coding-agent";

// Discover all skills from cwd/.bbcli/skills, ~/.bbcli/agent/skills, etc.
