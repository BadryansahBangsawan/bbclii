 ...
 * - ~/.bbcli/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.bbcli/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.bbcli/agent/extensions/ or .bbcli/extensions/
