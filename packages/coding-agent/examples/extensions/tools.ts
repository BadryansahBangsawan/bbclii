 ...
 *
 * Usage:
 * 1. Copy this file to ~/.bbcli/agent/extensions/ (legacy: ~/.pi/agent/extensions/) or your project's .bbcli/extensions/
 * 2. Use /tools to open the tool selector
 */
import type { ExtensionAPI, ExtensionContext } from "@bbcli/pi-coding-agent";
import { getSettingsListTheme } from "@bbcli/pi-coding-agent";
import { Container, type SettingItem, SettingsList } from "@bbcli/pi-tui";
