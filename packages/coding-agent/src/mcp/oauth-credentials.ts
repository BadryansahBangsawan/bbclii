 ...
 * local MCP manager and the `bbcli auth-broker serve` refresh path so a broker
 ...
 * the credential id (`bbcli token`) set `recoverServerUrlFromCredentialId` to derive
