	...
	eval: {
		...
		result: {
			content: [
				{
					type: "text",
					text: ["@bbcli/coding-agent v0.42.0", "37 dependencies"].join("\n"),
				},
			],
			details: {
				language: "python",
				languages: ["python"],
				jsonOutputs: [["@ai-sdk/anthropic", "@bbcli/pi-ai", "@bbcli/pi-tui"]],
				cells: [
					{
						index: 0,
						title: "load config",
						...
						output: ["@bbcli/coding-agent v0.42.0", "37 dependencies"].join("\n"),
						status: "complete",
						durationMs: 64,
						exitCode: 0,
					},
