 ...
 *
 * Handles `bbcli setup` for onboarding and `bbcli setup <component>` for optional dependencies.
 */
import * as path from "node:path";
import { APP_NAME, getProjectDir, getPythonEnvDir } from "@bbcli/pi-utils";
...
// package dependencies beyond a working interpreter. `bbcli setup python --check`
...
/**
 * Unified `bbcli setup speech` flow. Drives every {@link SpeechComponent} through
