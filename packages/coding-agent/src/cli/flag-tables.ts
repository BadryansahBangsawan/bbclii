 ...
 * `@bbcli/pi-utils` (or anything that transitively does). That package's
 ...
 * runtime imports from `@bbcli/pi-utils`, which is the whole reason it can
 ...
 */
export const PROFILE_BOOTSTRAP_BOUNDARY_ARG = "--bbcli-profile-boundary";
 ...
 * argument — `bbcli --print --profile work` still selects a profile) apart from an
 ...
 * a flag's value instead of mistaking it for the subcommand — `bbcli --model acp`
