...
import { directoryExists, getProjectDir, normalizePathForComparison, setProjectDir } from "@bbcli/pi-utils";
		...
		try {
			...
			const hint =
				code === "EACCES" || code === "EPERM"
					? " On macOS, grant bbcli Files & Folders or Full Disk Access permission for the target directory."
					: "";
