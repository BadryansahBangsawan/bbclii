import "@bbcli/pi-utils/env";
import chalk from "@bbcli/pi-utils/chalk";
import { APP_NAME, CONFIG_DIR_NAME } from "@bbcli/pi-utils/dirs";
...
export function getExtraHelpText(): string {
  ...
  Use \`bbcli --profile <name> --alias <command>\` to create a shell shortcut for a profile
...
${chalk.bold("Useful Commands:")}
  bbcli agents unpack           - Export bundled subagents to ~/.bbcli/agent/agents (default)
  bbcli agents unpack --project - Export bundled subagents to ./.bbcli/agents`;
}
