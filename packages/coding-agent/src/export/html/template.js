    (function() {
      ...
      const THEME_STORAGE_KEY = 'bbcli-export-theme';
      ...
      //  - Share viewer: share-loader.js sets `window.__BBCLI_SESSION_DATA__` to
      ...
      // ============================================================
      //
      // Tool calls render through the bundled <bbcli-tool-view> web component
      ...
      function renderToolCall(call, sctx, blockId) {
        ...
        return '<bbcli-tool-view class="tool-execution ' + statusClass + '" id="' + blockId + '" data-key="' + key + '" open></bbcli-tool-view>';
      }
      ...
      const pending = window.__BBCLI_SESSION_DATA__;
