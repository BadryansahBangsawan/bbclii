 ...
 */
import { type AuthStorage, type FetchImpl, withAuth } from "@bbcli/pi-ai";
...
export async function searchWithKagi(
	...
	const response = await withAuth(
		...
		},
		{
			...
			missingKeyMessage: "Kagi credentials not found. Set KAGI_API_KEY or login with 'bbcli /login kagi'.",
		},
	);
