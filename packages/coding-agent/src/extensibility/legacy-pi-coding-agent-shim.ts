 ...
 * `@bbcli/pi-coding-agent` (or one of its aliased scopes like
 ...
 * the same module identity as a direct `@bbcli/pi-coding-agent` import.
 */
...
import { type AuthCredential, SqliteAuthCredentialStore, type TSchema } from "@bbcli/pi-ai";
import { piEscapeRegexLiteral, piJoinPath } from "@bbcli/pi-ai/providers/cursor-pi-args";
import { getKeybindings, type Keybinding, Text } from "@bbcli/pi-tui";
import {
	getAgentDbPath,
	getAgentDir,
	getProjectDir,
...
// `getAgentDir`; `getProjectDir` (a `@bbcli/pi-utils` helper) and
...
export { getProjectDir } from "@bbcli/pi-utils";
...
export { calculateContextTokens, compact, serializeConversation } from "@bbcli/pi-agent-core/compaction";
...
export { CONFIG_DIR_NAME } from "@bbcli/pi-utils";
