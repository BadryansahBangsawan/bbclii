 ...
 * `.bbcli/tools/`, `.claude/tools/`, the plugin tree, and any configured paths.
 *
...
export async function discoverCustomToolPaths(configuredPaths: string[], cwd: string): Promise<ToolPathWithSource[]> {
	...
	// 2. Plugin tools: ~/.bbcli/plugins/node_modules/*/
 ...
 * 2. Installed plugins (~/.bbcli/plugins/node_modules/*)
