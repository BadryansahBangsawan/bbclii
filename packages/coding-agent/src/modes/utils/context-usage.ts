import type { Tokenizer } from "@bbcli/pi-agent-core";
import type { CompactionSettings } from "@bbcli/pi-agent-core/compaction";
import { effectiveReserveTokens, resolveThresholdTokens } from "@bbcli/pi-agent-core/compaction";
import type { Tool as AiTool, Model } from "@bbcli/pi-ai";
import { toolWireSchema } from "@bbcli/pi-ai/utils/schema";
import { formatNumber } from "@bbcli/pi-utils";
