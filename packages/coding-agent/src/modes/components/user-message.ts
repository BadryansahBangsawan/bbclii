import { applyBackgroundToLine, type Component, Container, Markdown, padding, visibleWidth } from "@bbcli/pi-tui";
...
// synthesized arrow keys on bbcli's pty, slamming the editor caret to column 0
// (#8030, #6115).
//
