 ...
 * argument list, tolerating both the bbcli `(theme)` and upstream-pi
...
export class CustomEditor extends Editor {
	 ...
	 * the upstream-pi `(tui, theme, keybindings)` convention. Undefined for bbcli's
	...
	/**
	 * Accept both the bbcli constructor convention — `new CustomEditor(theme)` —
