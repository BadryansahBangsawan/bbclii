/**
 * `bbcli __complete <kind> [-- <prefix>]` — dynamic completion candidates.
 *
 ...
 */
import { type GeneratedProvider, getBundledModels, getBundledProviders } from "@bbcli/pi-catalog/models";
import { Command } from "@bbcli/pi-utils/cli";
