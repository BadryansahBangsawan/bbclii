import { Args, type CommandMetadata, Flags } from "@bbcli/pi-utils/cli";
import { APP_NAME } from "@bbcli/pi-utils/dirs";
...
export const launchHelp = {
	...
	examples: [
		...
		`# Create a shell shortcut for a work profile\n  ${APP_NAME} --profile work --alias bbcli-work`,
		`# Use different model (fuzzy matching)\n  ${APP_NAME} --model opus "Help me refactor this code"`,
		`# Limit model cycling to specific models\n  ${APP_NAME} --models claude-sonnet,claude-haiku,gpt-4o`,
		`# Export a session file to HTML\n  ${APP_NAME} --export ~/.bbcli/agent/sessions/--path--/session.jsonl`,
	],
