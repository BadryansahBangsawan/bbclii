/**
 * `bbcli completions <bash|zsh|fish>` — print a shell completion script.
 *
...
import { APP_NAME, postmortem, VERSION } from "@bbcli/pi-utils";
import { Args, type CliConfig, Command, type CommandCtor } from "@bbcli/pi-utils/cli";
