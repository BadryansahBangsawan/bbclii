import type { AgentOptions } from "@bbcli/pi-agent-core";
import type { OAuthAccessResolution } from "@bbcli/pi-ai";
import type { ApiKeyResolver } from "@bbcli/pi-ai/auth-retry";
