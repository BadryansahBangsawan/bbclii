import type { Api, Model, ModelSpec, RemoteCompactionConfig, ThinkingConfig } from "@bbcli/pi-ai/types";
import { buildModel } from "@bbcli/pi-catalog/build";
import { isVertexExpressOpenAIUrl } from "@bbcli/pi-catalog/hosts";
import { PROVIDER_DESCRIPTORS } from "@bbcli/pi-catalog/provider-models";
