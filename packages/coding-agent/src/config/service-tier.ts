import type { ServiceTier, ServiceTierByFamily, ServiceTierFamily } from "@bbcli/pi-ai";
 ...
 * `bbcli bench --service-tier` flag, which apply one tier to whatever family the
