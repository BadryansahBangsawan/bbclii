...
import { getProjectDir, getProjectPromptsDir, getPromptsDir, logger, parseFrontmatter, prompt } from "@bbcli/pi-utils";
...
export async function loadPromptTemplates(options: LoadPromptTemplatesOptions = {}): Promise<PromptTemplate[]> {
	...
	// 2. Load project templates from cwd/.bbcli/prompts/
