 ...
 */
import { type ApiKey, type FetchImpl, withAuth } from "@bbcli/pi-ai";
import type { Api, Model, RemoteCompactionConfig } from "@bbcli/pi-ai/types";
...
} from "@bbcli/pi-catalog/identity";
import {
 ...
 * `qwen-template-false` dialect; bbcli emits `preserve_thinking` inside
