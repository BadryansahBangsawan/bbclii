 ...
 * the user run `bbcli browser-relay` by hand, the relay kind lazily starts one
...
export const RELAY_DAEMON_NAME = "bbcli.browser.relay";
const RELAY_BROKER_SCOPE = "browser-relay";
/** Matches the serve banner (`bbcli browser relay listening on http://…`). */
