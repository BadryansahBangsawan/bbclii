 ...
 *
 * Impersonates Chrome's CDP discovery endpoint so the bbcli browser tool (and
...
/** Default appearance of the bbcli tab group. */
const DEFAULT_GROUP = { title: "bbcli", color: "cyan" } as const;
