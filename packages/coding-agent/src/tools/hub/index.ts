...
const hubSchema = type({
	...
	"persist?": type("boolean").describe("start: survive the last bbcli client exiting; default false"),
	"detached?": type("boolean").describe(
		"start: survive every bbcli and broker exit; implies persist and disables PTY input",
	),
