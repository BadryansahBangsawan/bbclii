...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "@bbcli/pi-ai";
...
// Per-provider image-count budgets live in @bbcli/snapcompact
