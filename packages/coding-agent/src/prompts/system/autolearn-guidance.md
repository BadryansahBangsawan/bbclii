...
Managed skills: `SKILL.md` in isolated `~/.bbcli/agent/managed-skills`; surfaced in future sessions like other skills.
...
Isolation: managed skills ONLY writable skills. NEVER edit user-authored skills in `~/.bbcli/agent/skills` or `.bbcli/skills`.
