...
import { getDaemonRuntimeDir, isEisdir, isEnoent } from "@bbcli/pi-utils";

/** Resolve the private runtime directory shared by bbcli processes in one project directory. */
 ...
 * Written by the broker at startup so out-of-process inspectors (`bbcli ps`)
