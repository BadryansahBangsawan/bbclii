...
describe("provider error expand", () => {
	it("wraps a long single-line error across rows instead of cutting it at a fixed column", () => {
		...
		})}\nraw-http-request=/home/user/.bbcli/logs/http-400-requests/1756800000000-abc123.json`;
		...
		expect(joined).toContain("raw-http-request=/home/user/.bbcli/logs/http-400-requests/1756800000000-abc123.json");
