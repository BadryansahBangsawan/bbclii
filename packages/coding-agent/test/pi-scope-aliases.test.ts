 ...
 *   - `@plannotator/pi-extension`         ⇒ `@bbcli/pi-agent-core`
 *   - `@runfusion/fusion`                 ⇒ `@bbcli/pi-coding-agent/...`
 *
...
const canonicalCodingAgent = Bun.resolveSync("@bbcli/pi-coding-agent", import.meta.dir);
const canonicalCodingAgentExtensions = Bun.resolveSync(
	"@bbcli/pi-coding-agent/extensibility/extensions",
	import.meta.dir,
);
const canonicalUtils = Bun.resolveSync("@bbcli/pi-utils", import.meta.dir);
const canonicalTui = Bun.resolveSync("@bbcli/pi-tui", import.meta.dir);
// Subpath: upstream `pi-ai/oauth` re-exported `utils/oauth/index`; our pi-ai now
// exposes the same surface at the real `@bbcli/pi-ai/oauth` export, so the
// legacy `@mariozechner/pi-ai/oauth` specifier canonicalizes straight to it.
const canonicalAiOauth = Bun.resolveSync("@bbcli/pi-ai/oauth", import.meta.dir);
...
const CASES: readonly AliasCase[] = [
	...
	{ id: "ohmypi-utils", aliasSpecifier: "@bbcli/pi-utils", canonicalPath: canonicalUtils, symbol: "logger" },
	{
		id: "ohmypi-coding-agent",
		aliasSpecifier: "@bbcli/pi-coding-agent",
	...
	// Subpath: legacy `pi-ai/oauth` resolves to the real `@bbcli/pi-ai/oauth`.
	{
