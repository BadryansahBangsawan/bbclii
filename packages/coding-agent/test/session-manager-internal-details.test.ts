...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@bbcli/pi-coding-agent/session/messages";
import type { CustomMessageEntry } from "@bbcli/pi-coding-agent/session/session-entries";
