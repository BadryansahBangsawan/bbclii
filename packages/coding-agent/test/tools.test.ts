...
import type { AgentTool, AgentToolContext } from "@bbcli/pi-agent-core";
import { createMockModel } from "@bbcli/pi-ai/providers/mock";
import { AsyncJobManager } from "@bbcli/pi-coding-agent/async";
import { DEFAULT_BASH_INTERCEPTOR_RULES, Settings } from "@bbcli/pi-coding-agent/config/settings";
...
import { wrapToolWithMetaNotice } from "@bbcli/pi-coding-agent/tools/output-meta";
import { ReadTool } from "@bbcli/pi-coding-agent/tools/read";
import * as toolTimeouts from "@bbcli/pi-coding-agent/tools/tool-timeouts";
import { WriteTool } from "@bbcli/pi-coding-agent/tools/write";
import { $which, removeSyncWithRetries, Snowflake } from "@bbcli/pi-utils";
import { openArchive, readArchiveEntries } from "@bbcli/pi-utils/ar";
...
function createPaxHeader(typeFlag: "g" | "x", body: Buffer): Buffer {
	return tarRecord(createTarHeader("./PaxHeaders/bbcli", body.byteLength, typeFlag), body);
}
