...
import { type AgentMessage, Tokenizer } from "@bbcli/pi-agent-core";
import {
	...
	shouldCompact,
} from "@bbcli/pi-agent-core/compaction/compaction";
import * as ai from "@bbcli/pi-ai";
import { encodeTextSignatureV1 } from "@bbcli/pi-ai/providers/openai-shared";
import type { AssistantMessage, Model, ProviderPayload, Usage } from "@bbcli/pi-ai/types";
import { getBundledModel } from "@bbcli/pi-catalog/models";
import { buildSessionContext } from "@bbcli/pi-coding-agent/session/session-context";
import type {
	CompactionEntry,
	ModelChangeEntry,
	SessionEntry,
...
import { parseSessionEntries } from "@bbcli/pi-coding-agent/session/session-loader";
import { migrateSessionEntries } from "@bbcli/pi-coding-agent/session/session-migrations";
