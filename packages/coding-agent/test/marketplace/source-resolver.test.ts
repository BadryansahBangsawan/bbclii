...
import type { MarketplacePluginEntry } from "@bbcli/pi-coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@bbcli/pi-coding-agent/extensibility/plugins/marketplace";
...
describe("resolvePluginSource", () => {
	...
	beforeEach(() => {
		tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "bbcli-src-res-test-"));
	});
