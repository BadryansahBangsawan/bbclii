...
import { dedupeContainedContextFiles } from "@bbcli/pi-coding-agent/system-prompt";
...
describe("dedupeContainedContextFiles", () => {
	...
	it("treats files without a depth as less authoritative than project files", () => {
		...
		const files = [file("/project/AGENTS.md", project, 0), file("/home/user/.bbcli/AGENTS.md", user)];

		expect(paths(dedupeContainedContextFiles(files))).toEqual(["/home/user/.bbcli/AGENTS.md", "/project/AGENTS.md"]);
	});
