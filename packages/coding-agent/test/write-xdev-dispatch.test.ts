...
import { createTools, type Tool, type ToolSession } from "@bbcli/pi-coding-agent/tools";
import { requiresApproval, resolveApproval } from "@bbcli/pi-coding-agent/tools/approval";
import { githubToolRenderer } from "@bbcli/pi-coding-agent/tools/gh-renderer";
...
import {
	...
	xdevDocsAll,
	xdevEntries,
} from "@bbcli/pi-coding-agent/tools/xdev";
