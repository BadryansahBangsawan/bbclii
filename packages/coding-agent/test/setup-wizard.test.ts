...
import { runOnboardingSetup } from "@bbcli/pi-coding-agent/commands/setup";
...
import {
	...
	type SetupSceneHost,
	selectSetupScenes,
} from "@bbcli/pi-coding-agent/modes/setup-wizard";
import { providersSetupScene } from "@bbcli/pi-coding-agent/modes/setup-wizard/scenes/providers";
import { themeSetupScene } from "@bbcli/pi-coding-agent/modes/setup-wizard/scenes/theme";
import { WebSearchTab } from "@bbcli/pi-coding-agent/modes/setup-wizard/scenes/web-search";
import { SetupWizardComponent } from "@bbcli/pi-coding-agent/modes/setup-wizard/wizard-overlay";
...
import { SEARCH_PROVIDER_OPTIONS, SEARCH_PROVIDER_ORDER } from "@bbcli/pi-coding-agent/web/search/types";
