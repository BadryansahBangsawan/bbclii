...
import { resolveMemoryBackend } from "@bbcli/pi-coding-agent/memory-backend";
...
import { sharpshooterBackend } from "@bbcli/pi-coding-agent/sharpshooter/backend";
import { sharpshooterBankDir } from "@bbcli/pi-coding-agent/sharpshooter/paths";
import { executeAcpBuiltinSlashCommand } from "@bbcli/pi-coding-agent/slash-commands/acp-builtins";
import type { SlashCommandRuntime } from "@bbcli/pi-coding-agent/slash-commands/types";
