...
import type { MCPServer } from "@bbcli/pi-coding-agent/capability/mcp";
import type { MCPServerConnection, MCPTransport } from "@bbcli/pi-coding-agent/mcp/types";
...
import type { MCPRuntimeSource } from "@bbcli/pi-coding-agent/modes/components/extensions/mcp-runtime";
...
const githubServer: MCPServer = {
	...
	_source: {
		...
		path: "/home/sf/.bbcli/agent/mcp.json",
		level: "user",
	},
};
...
describe("MCP inspector runtime join", () => {
	...
	test("wraps a long command instead of ellipsizing it", () => {
		...
		panel.setExtension({
			...
			raw: {
				...githubServer,
				command: "/home/sf/worlds/personal/.bbcli/bin/gog-mcp-readonly",
			},
		});
