...
import { resetActiveRulesForTests, setActiveRules } from "@bbcli/pi-coding-agent/capability/rule";
...
import type { Skill } from "@bbcli/pi-coding-agent/extensibility/skills";
import { resetActiveSkillsForTests, setActiveSkills } from "@bbcli/pi-coding-agent/extensibility/skills";
...
import {
	...
	isInternalUrlPrefix,
} from "@bbcli/pi-coding-agent/modes/internal-url-autocomplete";
import { PromptActionAutocompleteProvider } from "@bbcli/pi-coding-agent/modes/prompt-action-autocomplete";
