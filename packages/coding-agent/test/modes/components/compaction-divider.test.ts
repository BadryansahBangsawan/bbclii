...
import { createCompactionSummaryMessage } from "@bbcli/pi-agent-core/compaction";
import type { ImageContent } from "@bbcli/pi-ai";
import { CompactionSummaryMessageComponent } from "@bbcli/pi-coding-agent/modes/components/compaction-summary-message";
