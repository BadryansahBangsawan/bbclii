 ...
 *
 * Also guards the cold-launch terminal cleanup: `bbcli` / `bbcli -c` leave the
...
import type { AssistantMessage, ImageContent, Message, Usage } from "@bbcli/pi-ai";
...
import type { SessionContext, StrippedToolCallsMarker } from "@bbcli/pi-coding-agent/session/session-context";
import { SessionManager } from "@bbcli/pi-coding-agent/session/session-manager";
import { type Component, Container, Image, ImageProtocol, setTerminalImageProtocol, TERMINAL } from "@bbcli/pi-tui";
