...
import type { Context, Model, SimpleStreamOptions } from "@bbcli/pi-ai";
...
import { createSettingsAwareStreamFn } from "@bbcli/pi-coding-agent/session/settings-stream-fn";
