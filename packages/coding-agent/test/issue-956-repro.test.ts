...
import * as mcpConfigWriter from "@bbcli/pi-coding-agent/mcp/config-writer";
...
import { getConfigRootDir, getProjectDir, removeWithRetries, setAgentDir, setProjectDir } from "@bbcli/pi-utils";
import {
