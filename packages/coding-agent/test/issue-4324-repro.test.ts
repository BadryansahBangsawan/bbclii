 ...
 * shows up in `~/.bbcli/logs/bbcli.log` without regressing idle-worker shutdown.
 */
import { describe, expect, it } from "bun:test";
import { createWorkerSubprocess, type SpawnedSubprocess } from "@bbcli/pi-coding-agent/subprocess/worker-client";
