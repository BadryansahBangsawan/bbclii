...
import { runConfigCommand } from "@bbcli/pi-coding-agent/cli/config-cli";
...
import { getConfigRootDir, setAgentDir, TempDir } from "@bbcli/pi-utils";
...
describe("config list output", () => {
	...
	beforeEach(() => {
		...
		agentDir = TempDir.createSync("@bbcli-config-credentials-");
