...
import { compileRuleCondition } from "@bbcli/pi-coding-agent/capability/rule";
import { buildRuleFromMarkdown, createSourceMeta } from "@bbcli/pi-coding-agent/discovery/helpers";
