...
import { completionBudgetReport, GoalRuntime } from "@bbcli/pi-coding-agent/goals/runtime";
import type { Goal, GoalModeState, GoalTokenUsage } from "@bbcli/pi-coding-agent/goals/state";
