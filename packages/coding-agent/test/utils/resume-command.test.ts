...
import { resumeCommand } from "@bbcli/pi-coding-agent/utils/resume-command";
import { APP_NAME, getActiveProfile, setProfile } from "@bbcli/pi-utils/dirs";
...
describe("resumeCommand", () => {
	...
	it("carries the active profile so the emitted hint is runnable verbatim", () => {
		// Profile sessions live in ~/.bbcli/profiles/<name>/agent, so a resume hint
