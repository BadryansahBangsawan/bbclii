...
import type { Api, AssistantMessage, completeSimple, Model } from "@bbcli/pi-ai";
import type { ModelSpec } from "@bbcli/pi-ai/types";
...
} from "@bbcli/pi-coding-agent/utils/image-vision-fallback";
