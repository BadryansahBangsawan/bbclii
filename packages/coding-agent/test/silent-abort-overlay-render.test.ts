...
import type { ObservableSession } from "@bbcli/pi-coding-agent/modes/session-observer-registry";
...
function makeSubagentRegistry(sessions: ObservableSession[]) {
	...
	} as unknown as import("@bbcli/pi-coding-agent/modes/session-observer-registry").SessionObserverRegistry;
}
