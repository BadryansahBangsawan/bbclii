...
import { CompactionCancelledError } from "@bbcli/pi-agent-core/compaction";
import type { CompactOptions } from "@bbcli/pi-coding-agent/extensibility/extensions/types";
import type { InteractiveModeContext } from "@bbcli/pi-coding-agent/modes/types";
import type { CompactMode } from "@bbcli/pi-coding-agent/session/compact-modes";
import { USER_INTERRUPT_LABEL } from "@bbcli/pi-coding-agent/session/messages";
import {
	ACP_BUILTIN_SLASH_COMMANDS,
	executeAcpBuiltinSlashCommand,
} from "@bbcli/pi-coding-agent/slash-commands/acp-builtins";
