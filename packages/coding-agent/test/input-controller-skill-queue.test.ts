...
import type { CompactionQueuedMessage, InteractiveModeContext } from "@bbcli/pi-coding-agent/modes/types";
...
import { SKILL_PROMPT_MESSAGE_TYPE, type SkillPromptDetails } from "@bbcli/pi-coding-agent/session/messages";
