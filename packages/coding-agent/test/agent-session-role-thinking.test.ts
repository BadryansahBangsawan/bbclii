...
import * as autoThinkingClassifier from "@bbcli/pi-coding-agent/auto-thinking/classifier";
...
import { AUTO_THINKING, clampAutoThinkingEffort, resolveProvisionalAutoLevel } from "@bbcli/pi-coding-agent/thinking";
