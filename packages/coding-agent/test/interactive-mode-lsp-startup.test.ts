...
import { LSP_STARTUP_EVENT_CHANNEL, type LspStartupEvent } from "@bbcli/pi-coding-agent/lsp/startup-events";
...
import type { LspStartupServerInfo } from "@bbcli/pi-coding-agent/tools";
