...
import { loadCapability } from "@bbcli/pi-coding-agent/capability";
...
import {
	...
	parseAgentPluginMcp,
} from "@bbcli/pi-coding-agent/discovery/agent-plugin-format";
import {
	clearClaudePluginRootsCache,
	injectPluginDirRoots,
	listClaudePluginRoots,
} from "@bbcli/pi-coding-agent/discovery/helpers";
import { getPluginsDir, removeWithRetries } from "@bbcli/pi-utils";
import { restoreEnvValue } from "../helpers/settings-test-state";
import "@bbcli/pi-coding-agent/discovery/agent-plugins";
import "@bbcli/pi-coding-agent/discovery/claude-plugins";
