...
import { loadCapability, setDisabledProviders } from "@bbcli/pi-coding-agent/capability";
import type { ContextFile } from "@bbcli/pi-coding-agent/capability/context-file";
import { clearCache } from "@bbcli/pi-coding-agent/capability/fs";
import type { Instruction } from "@bbcli/pi-coding-agent/capability/instruction";
import type { Prompt } from "@bbcli/pi-coding-agent/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@bbcli/pi-coding-agent/capability/rule";
import { RuleProtocolHandler } from "@bbcli/pi-coding-agent/internal-urls/rule-protocol";
import { removeSyncWithRetries } from "@bbcli/pi-utils";
import "@bbcli/pi-coding-agent/capability/context-file";
import "@bbcli/pi-coding-agent/capability/instruction";
import "@bbcli/pi-coding-agent/capability/prompt";
import "@bbcli/pi-coding-agent/capability/rule";
import "@bbcli/pi-coding-agent/discovery/github";
