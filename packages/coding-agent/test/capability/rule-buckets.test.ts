...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@bbcli/pi-coding-agent/capability/rule";
import { bucketRules } from "@bbcli/pi-coding-agent/capability/rule-buckets";
