...
import type { ToolInfo } from "@bbcli/pi-coding-agent/extensibility/extensions/types";
import { ExtensionList } from "@bbcli/pi-coding-agent/modes/components/extensions/extension-list";
import { liveToolsForExtension } from "@bbcli/pi-coding-agent/modes/components/extensions/inspector-model";
...
} from "@bbcli/pi-coding-agent/modes/components/extensions/live-tool-session";
...
describe("listLiveToolRecords snapshot", () => {
	...
	test("joins factory siblings on a UNC source path", () => {
		const unc = "\\\\server\\share\\.bbcli\\tools\\systemd.ts";
