...
import { renderSearchResult, type SearchRenderDetails } from "@bbcli/pi-coding-agent/web/search/render";
import type { SearchResponse } from "@bbcli/pi-coding-agent/web/search/types";
