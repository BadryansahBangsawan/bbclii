...
import { handleChocolatey } from "@bbcli/pi-coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@bbcli/pi-coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@bbcli/pi-coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@bbcli/pi-coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@bbcli/pi-coding-agent/web/scrapers/repology";
import { handleTerraform } from "@bbcli/pi-coding-agent/web/scrapers/terraform";
