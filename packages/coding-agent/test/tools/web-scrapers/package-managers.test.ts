...
import { handleAur } from "@bbcli/pi-coding-agent/web/scrapers/aur";
import { handleBrew } from "@bbcli/pi-coding-agent/web/scrapers/brew";
import { handleMaven } from "@bbcli/pi-coding-agent/web/scrapers/maven";
import { handleNuGet } from "@bbcli/pi-coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@bbcli/pi-coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@bbcli/pi-coding-agent/web/scrapers/rubygems";
