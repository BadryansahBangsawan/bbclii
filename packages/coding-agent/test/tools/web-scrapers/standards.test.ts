...
import { handleCheatSh } from "@bbcli/pi-coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@bbcli/pi-coding-agent/web/scrapers/rfc";
import { handleTldr } from "@bbcli/pi-coding-agent/web/scrapers/tldr";
