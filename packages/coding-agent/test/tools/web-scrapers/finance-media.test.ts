...
import { handleArtifactHub } from "@bbcli/pi-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@bbcli/pi-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@bbcli/pi-coding-agent/web/scrapers/discogs";
