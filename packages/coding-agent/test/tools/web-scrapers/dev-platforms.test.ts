...
import { handleDevTo } from "@bbcli/pi-coding-agent/web/scrapers/devto";
import { handleGitLab } from "@bbcli/pi-coding-agent/web/scrapers/gitlab";
import { handleHackerNews } from "@bbcli/pi-coding-agent/web/scrapers/hackernews";
import { handleLobsters } from "@bbcli/pi-coding-agent/web/scrapers/lobsters";
