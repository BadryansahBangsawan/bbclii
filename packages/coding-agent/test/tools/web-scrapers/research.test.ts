...
import { handleBiorxiv } from "@bbcli/pi-coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@bbcli/pi-coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@bbcli/pi-coding-agent/web/scrapers/wikidata";
