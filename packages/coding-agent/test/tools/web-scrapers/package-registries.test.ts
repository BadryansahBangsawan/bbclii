...
import { handleCratesIo } from "@bbcli/pi-coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@bbcli/pi-coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@bbcli/pi-coding-agent/web/scrapers/hex";
import { handleNpm } from "@bbcli/pi-coding-agent/web/scrapers/npm";
import { handlePubDev } from "@bbcli/pi-coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@bbcli/pi-coding-agent/web/scrapers/pypi";
