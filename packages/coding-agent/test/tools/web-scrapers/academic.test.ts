...
import { handleArxiv } from "@bbcli/pi-coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@bbcli/pi-coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@bbcli/pi-coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@bbcli/pi-coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@bbcli/pi-coding-agent/web/scrapers/types";
