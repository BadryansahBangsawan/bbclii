...
import {
	...
	holdBrowser,
	releaseBrowser,
} from "@bbcli/pi-coding-agent/tools/browser/registry";
import type { ReadyInfo, WorkerInbound, WorkerOutbound } from "@bbcli/pi-coding-agent/tools/browser/tab-protocol";
import {
	acquireTab,
