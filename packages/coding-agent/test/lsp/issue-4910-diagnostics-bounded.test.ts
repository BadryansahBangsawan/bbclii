...
import { getDiagnosticsForFile } from "@bbcli/pi-coding-agent/lsp/diagnostics";
import type { Diagnostic, LinterClient, ServerConfig } from "@bbcli/pi-coding-agent/lsp/types";
