...
import { generateRoomKey, importRoomKey } from "@bbcli/pi-coding-agent/collab/crypto";
import { CollabGuestLink } from "@bbcli/pi-coding-agent/collab/guest";
...
import {
	...
	formatCollabLink,
	parseCollabLink,
} from "@bbcli/pi-coding-agent/collab/protocol";
import { CollabSocket } from "@bbcli/pi-coding-agent/collab/relay-client";
import type {
	ExtensionAskDialogQuestion,
	ExtensionUIDialogOptions,
	ExtensionUISelectItem,
} from "@bbcli/pi-coding-agent/extensibility/extensions/types";
import { ExtensionUiController } from "@bbcli/pi-coding-agent/modes/controllers/extension-ui-controller";
import type { InteractiveModeContext, InteractiveSelectorDialogOptions } from "@bbcli/pi-coding-agent/modes/types";
