...
import { type AgentToolCall, Tokenizer } from "@bbcli/pi-agent-core";
import type { SessionMessageEntry } from "@bbcli/pi-agent-core/compaction/entries";
import { DEFAULT_PRUNE_CONFIG, pruneToolOutputs } from "@bbcli/pi-agent-core/compaction/pruning";
import { AGGRESSIVE_SHAKE_CONFIG, collectShakeRegions } from "@bbcli/pi-agent-core/compaction/shake";
import type { ProtectedToolContext } from "@bbcli/pi-agent-core/compaction/tool-protection";
import type { AssistantMessage, TextContent, ToolResultMessage, Usage } from "@bbcli/pi-ai";
import { createPlanReadMatcher } from "@bbcli/pi-coding-agent/plan-mode/plan-protection";
