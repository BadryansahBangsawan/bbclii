...
import type { Api, Message, Model } from "@bbcli/pi-ai";
...
import { SessionProviderBoundary } from "@bbcli/pi-coding-agent/session/session-provider-boundary";
import {
	modelLacksWebpSupport,
	normalizeModelContextImages,
	normalizeModelContextMessages,
	webpExclusionForModel,
} from "@bbcli/pi-coding-agent/utils/image-loading";
