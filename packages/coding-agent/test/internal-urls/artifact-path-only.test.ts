...
import { ArtifactProtocolHandler } from "@bbcli/pi-coding-agent/internal-urls/artifact-protocol";
...
import { resolveToolSearchScope } from "@bbcli/pi-coding-agent/tools/path-utils";
