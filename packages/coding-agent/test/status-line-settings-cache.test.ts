...
import { StatusLineComponent, type StatusLineSettings } from "@bbcli/pi-coding-agent/modes/components/status-line";
import { STATUS_LINE_PRESETS } from "@bbcli/pi-coding-agent/modes/components/status-line/presets";
...
import { removeSyncWithRetries, setProjectDir } from "@bbcli/pi-utils";
