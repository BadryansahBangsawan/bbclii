...
import { applyDisabledExtensionsToState } from "@bbcli/pi-coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@bbcli/pi-coding-agent/modes/components/extensions/types";
