...
import { resolveModels, runTinyModelsCommand } from "@bbcli/pi-coding-agent/cli/tiny-models-cli";
import { TINY_LOCAL_MODELS } from "@bbcli/pi-coding-agent/tiny/models";
...
describe("tiny-models download model resolution", () => {
	...
	it("prints actionable CUDA provider diagnostics from worker errors", async () => {
		...
		const diagnostic = [
			...
			"  side runtime: /home/user/.bbcli/cache/tiny-title-runtime/transformers-test/node_modules",
