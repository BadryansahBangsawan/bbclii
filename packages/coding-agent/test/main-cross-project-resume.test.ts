...
import * as modelResolverModule from "@bbcli/pi-coding-agent/config/model-resolver";
import { Settings } from "@bbcli/pi-coding-agent/config/settings";
import * as pluginHelpers from "@bbcli/pi-coding-agent/discovery/helpers";
import { createSessionManager, runRootCommand } from "@bbcli/pi-coding-agent/main";
import { AuthStorage } from "@bbcli/pi-coding-agent/session/auth-storage";
import type { SessionHeader } from "@bbcli/pi-coding-agent/session/session-entries";
import type { SessionInfo } from "@bbcli/pi-coding-agent/session/session-listing";
import * as sessionListingModule from "@bbcli/pi-coding-agent/session/session-listing";
import { loadEntriesFromFile } from "@bbcli/pi-coding-agent/session/session-loader";
import { SessionManager } from "@bbcli/pi-coding-agent/session/session-manager";
import { getProjectDir, normalizePathForComparison, setProjectDir } from "@bbcli/pi-utils";
