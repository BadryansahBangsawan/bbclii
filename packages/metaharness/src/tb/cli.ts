...
const HELP = `Terminal-Bench 2.1 runner (local bbcli, remote Vibemon microVMs)
...
Options:
  ...
  -c, --concurrency <n>         Concurrent trials (default 4)
      ...
      --gateway-url <url>       Local bbcli auth gateway (default http://127.0.0.1:4000)
      ...
      --rebuild-agent           Rebuild cached bbcli binaries
