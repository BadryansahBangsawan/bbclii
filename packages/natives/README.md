...
```typescript
import { encodeSixel, grep, pdfToMarkdown } from "@bbcli/pi-natives";
...
`@bbcli/pi-natives` publishes a small core package plus generated
...
npm/<platform>-<arch>/   # Generated at publish time, not committed
  package.json           # @bbcli/pi-natives-<platform>-<arch>
