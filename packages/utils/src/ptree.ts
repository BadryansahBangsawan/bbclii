...
import { Process } from "@bbcli/pi-natives";
...
const LINUX_SUBREAPER_COMMAND_ENV = "BBCLI_PTREE_SUBREAPER_COMMAND";
const LINUX_SUBREAPER_BUN_BE_BUN_ENV = "BBCLI_PTREE_SUBREAPER_BUN_BE_BUN";
