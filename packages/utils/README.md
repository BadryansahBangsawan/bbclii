...
| Module                                                                                                             | Purpose                                                                                      |
| ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------- |
| `logger`                                                                                                           | Centralized logger writing to `~/.bbcli/logs/` with rotation (TUI-safe — never stdout)         |
| `prompt`                                                                                                           | Handlebars-based prompt templating and formatting helpers                                    |
| `dirs`                                                                                                             | Path helpers for bbcli config directories (`~/.bbcli`, XDG-aware on Linux)                       |
...
Import from the root barrel or per-module subpaths (`@bbcli/pi-utils/<module>`).

## Install

```sh
bun add @bbcli/pi-utils
```
