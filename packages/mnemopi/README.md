...
Local SQLite memory engine for BBCLI agents.
...
```ts
import { Mnemopi } from "@bbcli/pi-mnemopi";
...
The BBCLI coding-agent wrapper adds `mnemopi.scoping` on top of those constructor options:
