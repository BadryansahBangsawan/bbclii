...
import type { SessionEntry, SessionMessageEntry, ShakeConfig } from "@bbcli/pi-agent-core/compaction";
import {
...
import type { AssistantMessage, ImageContent, TextContent, ToolCall, ToolResultMessage } from "@bbcli/pi-ai";
