import { encodeSixel } from "@bbcli/pi-natives";
import { $env, isBunTestRuntime, isTerminalHeadless, isWsl } from "@bbcli/pi-utils";
...
function osc99Id(id: string | undefined): string {
	return sanitizeOsc99Id(id) || `bbcli-${nextOsc99NotificationId++}`;
}
