...
import {
	...
	type Tokens,
} from "@bbcli/pi-utils/marked";
import { mathBlockAt, mathSpanAt, mathStartIndex } from "@bbcli/pi-utils/math-delimiters";
...
// Delimiters come from `@bbcli/pi-utils/math-delimiters`; rendering policy stays here.
